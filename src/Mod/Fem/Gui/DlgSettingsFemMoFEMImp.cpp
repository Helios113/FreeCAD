...
void DlgSettingsFemMoFEMImp::saveSettings()
{
    ...
    ui->cb_readmed_std->onSave();
    ui->cb_mbconvert_std->onSave();
...
void DlgSettingsFemMoFEMImp::loadSettings()
{
    ...
    ui->cb_readmed_std->onRestore();
    ui->cb_mbconvert_std->onRestore();
    ...
    ui->fc_mbconvert_path->onRestore();
}
